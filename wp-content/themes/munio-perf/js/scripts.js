jQuery(function ($) {
	...
	function PageLoad() {
		...
		setTimeout(function () {
			...
			TweenMax.to($('.hold-progress-bar'), 0.5, {
				force3D: true, width: '100%', delay: 1, ease: Power2.easeOut, onComplete: function () {  //modified time
					...
					$('body').waitForImages({
						finished: function () {
							...
							setTimeout(function () {
								...
								// FAIL-SAFE for LiteSpeed Cache Lazy Load / WebP
								setTimeout(function () {
									$('body').removeClass('loading').removeClass('hidden-ball').removeClass('show-loader');
									TweenMax.to($("#header-container, .header-middle, #footer-container"), 1, { force3D: true, opacity: 1, delay: 0, ease: Power2.easeOut });
								}, 3000);
	...
	function LazyLoad() {
		...
		setTimeout(function () {
			if (!isBodyLoaded) {
				isBodyLoaded = true;
				$('body').removeClass('loading').removeClass('hidden').removeClass('scale-up').removeClass('scale-none');
				TweenMax.to($("#header-container, .header-middle"), 1, { force3D: true, opacity: 1, ease: Power2.easeOut });
			}
		}, 3000);
		...
		if ($('.portfolio-wrap').length > 0) {
			...
			$('#main-page-content.portfolio-page').on('mousedown', function (event) {
				...
				TweenMax.to(progress, 1, {
					force3D: true, backgroundColor: 'rgba(255, 255, 255, 1)', onComplete: function () {
