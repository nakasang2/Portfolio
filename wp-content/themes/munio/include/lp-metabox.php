...
if ( ! function_exists( 'munio_lp_save_metabox' ) ) {
	function munio_lp_save_metabox( $post_id ) {
		...
		$text_fields = array(
			...
			'lp_about_image', 'lp_about_name', 'lp_about_skills',
			'lp_works_count', 'lp_works_category', 'lp_works_cta_text', 'lp_works_cta_url',
			'lp_limited_headline', 'lp_limited_cta_text', 'lp_limited_cta_url',
			'lp_film_video_url', 'lp_film_poster_url', 'lp_film_title', 'lp_film_subtitle',
