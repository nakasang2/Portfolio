	...
	if( !class_exists( "Clapat\Munio\Metaboxes\Meta_Boxes" ) ){
		...
		class Meta_Boxes {
			...
			public static function build_metabox( $post, $args ) {
				...
				$admin_notices .= '<div class="clapat-metabox-notice-save" style="display:none;">' . __('Settings have changed, you should save them!', 'clapat_munio_plugin_text_domain') . '</div>';
				$admin_notices .= '</div>';
			...
			public static function init() {
				...
				add_action( 'clapat/munio/add_metaboxes', array( __CLASS__, 'register_metabox_definitions' ) );
